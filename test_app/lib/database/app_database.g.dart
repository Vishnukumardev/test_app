...
class $UsersTable extends Users with TableInfo<$UsersTable, User> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, name, job, isSynced];
  @override
...
class User extends DataClass implements Insertable<User> {
  ...
  User copyWith({int? id, String? name, String? job, bool? isSynced}) => User(
        id: id ?? this.id,
        name: name ?? this.name,
        job: job ?? this.job,
  ...
  @override
  int get hashCode => Object.hash(id, name, job, isSynced);
  @override
